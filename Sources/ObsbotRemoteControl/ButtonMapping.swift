...
public let defaultRemoteButtonCaptureURL = URL(
  fileURLWithPath: "Resources/remote-button-capture.json")
...
public struct ButtonMapCapture: Codable {
  ...
  public init(
    capturedAt: String, vendorID: String?, productID: String?, seize: Bool, buttons: [ButtonCapture]
  ) {
...
public struct HIDEventRecord: Codable {
  ...
  public init(
    usagePage: UInt32, usage: UInt32, value: Int, state: String, name: String,
